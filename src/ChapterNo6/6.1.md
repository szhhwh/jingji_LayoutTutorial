...
2. 点击上方菜单栏的**一键解压**按钮![](Pasted%20image%2020230730110510.png)
3. 360压缩会将当前压缩包内的文件解压到**压缩包所在目录/压缩包名称**内
> [!Note]
> 使用一键解压时可以开启**自动关闭360压缩**功能减少操作次数
> ![](Pasted%20image%2020230730110628.png)

#### 手动解压
1. 打开压缩包
2. 点击上方菜单栏的**解压到**按钮![](Pasted%20image%2020230730111057.png)
3. 调整解压位置和其他参数后点击**立即解压**即可

#### 压缩
1. 选中需要压缩的文件，右键选择**添加到压缩文件（A）**![](Pasted%20image%2020230730113507.png)
2. 选择压缩配置并点击立即压缩![](Pasted%20image%2020230730113538.png)
> [!note]
...
1. 打开 7-Zip 软件
2. 点击**菜单栏->工具->选项**![](Pasted%20image%2020230730115731.png)
3. 点击需要关联的文件类型右侧的黄色区域将黄色框内的文字调整至显示**7-Zip**![](Pasted%20image%2020230730115914.png)
...
2. 点击菜单栏上方的**提取**按钮![](Pasted%20image%2020230730120811.png)
3. 选择需要解压到的位置并点击确定即可![](Pasted%20image%2020230730120855.png)

#### 压缩
1. 在文件资源管理器中选择需要压缩的文件并右键选择**添加到压缩包**![](Pasted%20image%2020230730121002.png)
2. 调整压缩参数（通常仅调整**压缩格式**和**压缩等级**即可）并点击**确定**按钮![](Pasted%20image%2020230730121113.png)
参数参考：
- 压缩格式：
...
![](Pasted%20image%2020230730115308.png)
